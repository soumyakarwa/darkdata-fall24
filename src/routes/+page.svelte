...
<section>
	...
	<div class="content">
		...
		Against this backdrop, our zine presents 10 projects developed as part of the “Dark Data” course. Drawing inspiration from course material, these projects investigate critical topics from surveillance and the media to the misuse of digital technology, and from gendered AI harms to missing data sets. Collectively, through these individual explorations, we hope to paint a broader picture of the “Dark Data” landscape.<br><br>

		While the onus for safeguarding personal data should not exclusively be placed on consumers, we’ve witnessed, time and time again, that legislation often lags behind technological advancements. This dynamic has played out repeatedly this past year, and the consequences have been devastating. The tragic death of a 14-year-old boy using Character AI-a platform for creating AI-powered virtual friends-prompted the company to rush to implement child safety measures. Similarly, student-generated DeepFake pornography has swirled through school hallways worldwide while administrators have scrambled to update school AI policies. Though social media platforms like Instagram have recently introduced new restrictions for users under 18, these efforts still leave users bearing much of the burden to protect themselves.<br><br>
